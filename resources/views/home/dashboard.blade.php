...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{asset('user/dist/css/style.min.css')}}" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="{{asset('user/dist/css/pages/dashboard1.css')}}" rel="stylesheet">
...
<body class="horizontal-nav skin-megna-dark fixed-layout">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/img/nh_itp.png" alt="homepage" class="" width="200" height="50"/>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                   <i class="fa fa-power-off m-r-5 m-l-5"></i> <button type="submit">Logout</button>
                                </form>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h1 class="text-center m-4" >Hello User Dashboard</h1>
    ...
    <script src="{{ asset('user/dist/js/perfect-scrollbar.jquery.min.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('user/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('user/dist/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('user/dist/js/custom.min.js') }}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    ...
    <!-- Chart JS -->
    <script src="{{ asset('user/dist/js/dashboard1.js') }}"></script>
</body>
