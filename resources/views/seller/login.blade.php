...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Seller</p>
        </div>
    </div>
    <!-- ============================================================== -->
        ...
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card rounded">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal form-material" id="loginform" action="{{ route('seller.login') }}" method="POST">
                        @csrf
                        <h3 class="box-title m-b-20 text-center">Seller Login</h3>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <a href="{{ route('seller.register') }}" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Register</a>
                                </div>
                            </div>
                        </div>
