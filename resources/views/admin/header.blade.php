                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/img/nh_itp.png" alt="homepage" class="dark-logo" width="200" height="50"/>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class=""><img src="../assets/images/users/4.jpg" alt="user" class="img-circle" width="60"></div>
                                    <div class="m-l-10">
                                          <h4 class="m-b-0">Aung Zaw Moe</h4>
                                        <p class=" m-b-0">azm@gmail.com</p>
                                    </div>
                                </div>
